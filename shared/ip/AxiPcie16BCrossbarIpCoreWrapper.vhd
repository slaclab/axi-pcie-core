-------------------------------------------------------------------------------
-- File       : AxiPcie16BCrossbarIpCoreWrapper.vhd
...
entity AxiPcie16BCrossbarIpCoreWrapper is
   generic (
      TPD_G             : time := 1 ns;
...
end AxiPcie16BCrossbarIpCoreWrapper;

architecture mapping of AxiPcie16BCrossbarIpCoreWrapper is
