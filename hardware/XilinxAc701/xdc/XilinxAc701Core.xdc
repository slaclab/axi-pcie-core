...
create_generated_clock -name sysClk   [get_pins {U_Core/REAL_PCIE.U_AxiPciePhy/U_AxiPcie/inst/comp_axi_enhanced_pcie/comp_enhanced_core_top_wrap/axi_pcie_enhanced_core_top_i/pcie_7x_v2_0_2_inst/pcie_top_with_gt_top.gt_ges.gt_top_i/pipe_wrapper_i/pipe_clock_int.pipe_clock_i/mmcm_i/CLKOUT2}]
...
set_clock_groups -asynchronous -group [get_clocks {sysClk}] -group [get_clocks {dnaClk}] -group [get_clocks {dnaClkL}] -group [get_clocks {iprogClk}]
set_clock_groups -asynchronous -group [get_clocks {sysClk}] -group [get_clocks {dnaClk}] -group [get_clocks {dnaClkL}] -group [get_clocks {iprogClk}]
