-------------------------------------------------------------------------------
-- File       : AxiPcie64BCrossbarIpCoreWrapper.vhd
...
entity AxiPcie64BCrossbarIpCoreWrapper is
   generic (
      TPD_G             : time := 1 ns;
...
end AxiPcie64BCrossbarIpCoreWrapper;

architecture mapping of AxiPcie64BCrossbarIpCoreWrapper is

   component AxiPcie64BCrossbarIpCore10Ports
      port (
   ...
   component AxiPcie64BCrossbarIpCore9Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie64BCrossbarIpCore8Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie64BCrossbarIpCore7Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie64BCrossbarIpCore6Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie64BCrossbarIpCore5Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie64BCrossbarIpCore4Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie64BCrossbarIpCore3Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
...
begin
   ...
   DMA_8Lane : if (DMA_SIZE_G = 8) generate
      U_AxiCrossbar : AxiPcie64BCrossbarIpCore10Ports
         port map (
   ...
   DMA_7Lane : if (DMA_SIZE_G = 7) generate
      U_AxiCrossbar : AxiPcie64BCrossbarIpCore9Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_6Lane : if (DMA_SIZE_G = 6) generate
      U_AxiCrossbar : AxiPcie64BCrossbarIpCore8Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_5Lane : if (DMA_SIZE_G = 5) generate
      U_AxiCrossbar : AxiPcie64BCrossbarIpCore7Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_4Lane : if (DMA_SIZE_G = 4) generate
      U_AxiCrossbar : AxiPcie64BCrossbarIpCore6Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_3Lane : if (DMA_SIZE_G = 3) generate
      U_AxiCrossbar : AxiPcie64BCrossbarIpCore5Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_2Lane : if (DMA_SIZE_G = 2) generate
      U_AxiCrossbar : AxiPcie64BCrossbarIpCore4Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_1Lane : if (DMA_SIZE_G = 1) generate
      U_AxiCrossbar : AxiPcie64BCrossbarIpCore3Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
