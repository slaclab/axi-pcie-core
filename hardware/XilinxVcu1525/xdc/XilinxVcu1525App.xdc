...
set_property PACKAGE_PIN M11 [get_ports { qsfp0RefClkP[0] }] ;# 156.25 MHz
set_property PACKAGE_PIN M10 [get_ports { qsfp0RefClkN[0] }] ;# 156.25 MHz
set_property PACKAGE_PIN K11 [get_ports { qsfp0RefClkP[1] }] ;# 156.25 MHz
set_property PACKAGE_PIN K10 [get_ports { qsfp0RefClkN[1] }] ;# 156.25 MHz
...
set_property PACKAGE_PIN T11 [get_ports { qsfp1RefClkP[0] }] ;# 156.25 MHz
set_property PACKAGE_PIN T10 [get_ports { qsfp1RefClkN[0] }] ;# 156.25 MHz
set_property PACKAGE_PIN P11 [get_ports { qsfp1RefClkP[1] }] ;# 156.25 MHz
set_property PACKAGE_PIN P10 [get_ports { qsfp1RefClkN[1] }] ;# 156.25 MHz
