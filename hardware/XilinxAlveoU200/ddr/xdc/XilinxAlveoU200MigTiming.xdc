...
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells {U_Mig/GEN_MIG1.U_Mig1}]
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells {U_MigDmaBuffer/GEN_FIFO[2].U_AxiFifo}]
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells {U_MigDmaBuffer/GEN_FIFO[3].U_AxiFifo}]
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells {U_MigDmaBuffer/GEN_XBAR[1].U_DdrSync}]
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells {U_MigDmaBuffer/GEN_XBAR[1].U_XBAR}]
