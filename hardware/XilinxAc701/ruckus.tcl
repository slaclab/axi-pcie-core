...
if { $::env(PRJ_PART) != "XC7A200TFBG676-2" } {
   puts "\n\nERROR: PRJ_PART was not defined as XC7A200TFBG676-2 in the Makefile\n\n"; exit -1
}
...
loadConstraints -path "$::DIR_PATH/xdc/XilinxAc701Core.xdc"
loadConstraints -path "$::DIR_PATH/xdc/XilinxAc701App.xdc"
