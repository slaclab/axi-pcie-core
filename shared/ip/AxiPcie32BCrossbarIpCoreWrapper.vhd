...
entity AxiPcie32BCrossbarIpCoreWrapper is
   generic (
      TPD_G             : time := 1 ns;
...
end AxiPcie32BCrossbarIpCoreWrapper;

architecture mapping of AxiPcie32BCrossbarIpCoreWrapper is

   component AxiPcie32BCrossbarIpCore10Ports
      port (
   ...
   component AxiPcie32BCrossbarIpCore9Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie32BCrossbarIpCore8Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie32BCrossbarIpCore7Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie32BCrossbarIpCore6Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie32BCrossbarIpCore5Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie32BCrossbarIpCore4Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
   ...
   component AxiPcie32BCrossbarIpCore3Ports
      port (
         INTERCONNECT_ACLK    : in  std_logic;
         INTERCONNECT_ARESETN : in  std_logic;
         -- SLAVE[0]
...
begin
   ...
   DMA_8Lane : if (DMA_SIZE_G = 8) generate
      U_AxiCrossbar : AxiPcie32BCrossbarIpCore10Ports
         port map (
   ...
   DMA_7Lane : if (DMA_SIZE_G = 7) generate
      U_AxiCrossbar : AxiPcie32BCrossbarIpCore9Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_6Lane : if (DMA_SIZE_G = 6) generate
      U_AxiCrossbar : AxiPcie32BCrossbarIpCore8Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_5Lane : if (DMA_SIZE_G = 5) generate
      U_AxiCrossbar : AxiPcie32BCrossbarIpCore7Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_4Lane : if (DMA_SIZE_G = 4) generate
      U_AxiCrossbar : AxiPcie32BCrossbarIpCore6Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_3Lane : if (DMA_SIZE_G = 3) generate
      U_AxiCrossbar : AxiPcie32BCrossbarIpCore5Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_2Lane : if (DMA_SIZE_G = 2) generate
      U_AxiCrossbar : AxiPcie32BCrossbarIpCore4Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
   ...
   DMA_1Lane : if (DMA_SIZE_G = 1) generate
      U_AxiCrossbar : AxiPcie32BCrossbarIpCore3Ports
         port map (
            INTERCONNECT_ACLK    => axiClk,
            INTERCONNECT_ARESETN => axiRstL,
            -- SLAVE[0]
