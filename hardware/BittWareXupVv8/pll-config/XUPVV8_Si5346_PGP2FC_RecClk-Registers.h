 ...
 * Timestamp:                                          2024-10-09 14:59:12 GMT-07:00
 *
...
#define SI5346_REVD_REG_CONFIG_NUM_REGS				554
 ...
 * 
 * Part:               Si5346AB Rev D
 * Project File:       C:\Users\cbakalis\OneDrive - SLAC National Accelerator Laboratory\Documents\XUPVV8_Si5346_PGP2FC_RecClk.slabtimeproj
 * Design ID:          <none>
 * Created By:         ClockBuilder Pro v4.11.0.1 [2023-09-14]
 * Timestamp:          2024-10-09 14:59:11 GMT-07:00
 * 
 * Design Rule Check
 * =================
 * 
 ...
 * 
 * Warnings:
 * - OUT0 [185.714286 MHz] and OUT1 [185.714286 MHz] may have coupling [1]
 * 
 * Footnotes:
 ...
 * Device Grade
 * ============
 * Maximum Output Frequency: 185.714286 MHz
 ...
 *    MA = 371.428572
 *    N0 = 19.0615384322130177... [ 19 + 1904761/30952381 ]
 *    Nominal Bandwidth:
 *      Desired: 100.000 Hz
 *      Actual:  79.607 Hz
 *      Coefficients:
 ...
 * DSPLL B:
 *    Fpfd = 1.9969278064516129... MHz [ 1 + 15452381/15500000 MHz ]
 *    Fdco = 742.857144 MHz
 *    I/O Delay not enabled
 *    MB = 372
 *    N1 = 19.0615384322130177... [ 19 + 1904761/30952381 ]
 *    Nominal Bandwidth:
 *      Desired: 100.000 Hz
 *      Actual:  79.457 Hz
 *      Coefficients:
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  911 mW   887 mW   25 C  41 C
 * 
 *                                        -----------------------
 *                                                Typical        
 *                                        -----------------------
 ...
 * VDD                                       1.80      171    307
 * VDDA                                      3.30      120    395
 * VDDO0  OUT0    185.714286 MHz    LVDS     3.30       16     52
 * VDDO1  OUT1    185.714286 MHz    LVDS     3.30       16     52
 * VDDO2  OUT2    185.714286 MHz    LVDS     3.30       16     52
 * VDDO3  OUT3    185.714286 MHz    LVDS     3.30       16     52
 *                                        -------  -------  -----
 *                                           1.80      171    307
 *                                           3.30      183    604
 *                                        -------  -------  -----
 ...
 * 0x005E[25:0]  OOF1_RATIO_REF              16227961           0x0F79E79        
 ...
 * 0x00A4[28:0]  LOL_CLR_DELAY_DIV256_PLLA   25029              0x000061C5       
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256_PLLB   25030              0x000061C6       
 ...
 * 0x0212[47:0]  P1_NUM                      93                 0x00000000005D   
 ...
 * 0x0294[3:0]   FASTLOCK_EXTEND_SCL_PLLA    11                 0xB              
 ...
 * 0x0302[43:0]  N0_NUM                      75520000000        0x0119557C000    
 * 0x0308[31:0]  N0_DEN                      3961904768         0xEC25DE80       
 * 0x030C[0]     N0_UPDATE                   0                  0x0              
 * 0x030D[43:0]  N1_NUM                      75520000000        0x0119557C000    
 * 0x0313[31:0]  N1_DEN                      3961904768         0xEC25DE80       
 ...
 * 0x040F[5:0]   FASTLOCK_BW1_PLLA           38                 0x26             
 ...
 * 0x0415[55:0]  M_NUM_PLLA                  1521371430912      0x00016238CDC000 
 * 0x041C[31:0]  M_DEN_PLLA                  4096000000         0xF4240000       
 ...
 * 0x0432[23:0]  HOLD_15M_CYC_COUNT_PLLA     834                0x000342         
 ...
 * 0x0515[55:0]  M_NUM_PLLB                  798863917056       0x0000BA00000000 
 ...
 * 0x0532[23:0]  HOLD_15M_CYC_COUNT_PLLB     835                0x000343         
 ...
 * 0x059D[5:0]   HOLDEXIT_BW0_PLLB           15                 0x0F             
 ...
 * 0x0949[7:4]   IN_PULSED_CMOS_EN           8                  0x8              
