...
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks {ddrClkP0}] -group [get_clocks {sysClk}] 

set_property HIGH_PRIORITY true [get_nets {U_Core/U_Mig0/U_MIG/inst/u_ddr4_infrastructure/div_clk}]
