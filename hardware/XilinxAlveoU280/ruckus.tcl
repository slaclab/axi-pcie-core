...
if { $::env(PRJ_PART) != "XCU280-FSVH2892-2L-E" } {
   puts "\n\nERROR: PRJ_PART was not defined as XCU280-FSVH2892-2L-E in the Makefile\n\n"; exit -1
}
...
#######################################################################################
# Note: The hardware/XilinxAlveoU280/ddr is not included in this ruckus.tcl.
